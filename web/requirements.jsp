                                                                ...
                                                                <div class="mod-content clearfix">	
                                                                    <div class="mod-inner clearfix">
                                                                       ...
                                                                       <center> <section class="entry-content"> 
                                                                               <h1><b><u>Membership Requirements</u></b></h1>
                                                                                    <p>&nbsp;</p>
                                                                                   
                                                                                    <p><strong>	For engineers:</strong></p>
                                                                                    <ul style="align-items: baseline">                                                                                    
                                                                                    <li>	Upload bank pay slip of non-refundable fee of 10,000Rwf as Application fee</li>
                                                                                    <li>	Upload Notified Degree certificates</li> 
                                                                                    <li>Upload CV</li>
                                                                                    <p>Upload Photocopy of national Identity card</p> 
                                                                                    <p>Upload passport photos</p>
                                                                                    <p>Upload Technical report in any professional involvement (if any).</p> 
                                                                                    <p><strong>	For engineering consulting firms:</strong></p> 
                                                                                    <p>Upload a certificate of business registration name or a certificate of corporation issued by RDB.</p>
                                                                                   
                                                                                    <p>	Upload curriculum vitae for the managing director or curriculum vitae for a registered corporate engineer if managing director is not a registered engineer.</p>
                                                                                    <p>	Upload a passport photos of managing director.</p>
                                                                                    <p>	Upload bank pay slip of non-refundable fee of 20,000Rwf as Application fee</p>

                                                                                    <p><strong>N.B: All payments are made on institution’s account No 011 13011 24 opened in G.T BANK</strong></p>
                                                                                    </ul>
