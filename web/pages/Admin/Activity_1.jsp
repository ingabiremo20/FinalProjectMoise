        ...
        <div id="content">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <form role="form" action="../forms/Activity_Process.jsp" method="post">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Activity Name</label>

                                            <select class="form-control" name="activitname" value="${st.activitname }" required="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="activitbigDate" id="exampleInputEmail1" value="${st.activitbigDate}" placeholder="Starting Date">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">TO</label>
                                            <input type="text" class="form-control" name="activitendDate" id="exampleInputEmail1" value="${st.activitendDate }" placeholder="Ending Date">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">id</label>
                                            <input type="text" class="form-control" name="activitendDate" value="${st.activid }" id="exampleInputEmail1" value="${st.activitendDate}" placeholder="Ending Date">
                                        </div>
                                        <!-- /.box-body -->
            ...
            <div id="right">
                <div class="well well-small">
                    ...
                    <a href="../examples/Enginer_report.jsp" class="btn btn-default" style="color: #00ce53" target="_blank">Suspended Members</a>
                    <a href="../examples/Enginer_report.jsp" class="btn btn-default" style="color: #000088" target="_blank">Requesting Members</a>
