            ...
            <div class="inner" style="min-height: 300px;">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <center>  <h2>Accepted Members by Parameters</h2></center>
                ...
                <div class="header_bg">
                    <div class="header">
                        <div class="head-t">
                            <div class="header_bg">
                                <form action="AllAcceptedMembers.jsp" method="post">
                                    <table border="0">
                                        <tbody>
                                            <tr>
                                                <td>From  :</td>
                                                <td><input type="text" name="d1" value="" style="height: 30px;" placeholder="yyyy-MM-dd"/></td>
                                                <td>To  :</td>
                                                <td><input type="text" name="d2" value=""  style="height: 30px; "placeholder="yyyy-MM-dd"/></td>
                                                <td>Category</td>
                                                <td>
                                                    <select name="d3" style="height: 30px;">
                ...
                <div style="margin-left: 50px;margin-right: 10px">     
                    ...
                    <div  style="overflow: auto">
                        <table border="1" id="myDemo">
                            ...
                            <tr>
                                ...
                                <td><%=resultset.getString(10)%> <%=resultset.getString(2)%></td>                                                               
                    ...
                    <div class="row no-print">
                        <div class="col-xs-12" >
                            <a href="Enginer_report.jsp?d1=<%=request.getParameter("d1")
                                    + "&d2=" + request.getParameter("d2")
                                    + "&d3=" + request.getParameter("d3")%>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print</a>
