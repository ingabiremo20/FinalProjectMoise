                                ...
                                <form role="form" action="../forms/Activity_Process.jsp" method="post">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" name="activitbigDate" id="exampleInputEmail1" placeholder="Starting Date">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">TO</label>
                                            <input type="date" class="form-control" name="activitendDate" id="exampleInputEmail1" placeholder="Ending Date">
                                        </div>
                                        <!-- /.box-body -->
