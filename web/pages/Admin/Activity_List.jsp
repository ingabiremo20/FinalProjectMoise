...
<body class="hold-transition skin-blue sidebar-mini" >
    ...
    <div id="wrap" >
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 30px;">
                <div class="row">
                ...
                <div style="margin-left: 50px;margin-right: 10px">     
                    <center> <h4><b>Open Activities List</b></h4></center>
                    <div  style="overflow: auto">
                        <table border="1" id="myDemo">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><%=no%></td>
                                    <td><a href="UpdateActiv.jsp?id=<%=ls.get(i).getActivid()%>"><img src="../examples/img/upda.PNG" width="25" height="25"/></a>
                                    ...
                                    <td><a href="Update_activityClosed.jsp?activid=<%=ls.get(i).getActivid()%>&op=Closed"><img src="../examples/images/close.jpeg" width="32" height="32" alt="lock_open"/>
                                        </a></td>
                                </tr>
                                <%
                                        no++;
