                ...
                <div style="margin-left: 50px;margin-right: 10px">     
                        ...
                        <table border="1" id="myDemo">
                            ...
                            <tbody>
                                ...
                                <%
                                    ...
                                    List<Engineer> muList = dd.ViewSingleCompanyProjectDetails(session.getAttribute("proid").toString());
                                ...
                                <tr>
                                    <td><%=muList.get(row).getProjectid()%></td>
                                    <td><%=muList.get(row).getProjectname()%></td>
                                    <td><%= muList.get(row).getProjectYear()%></td>
                                    <td><%= muList.get(row).getProjectClient()%></td>
                                </tr>
                    ...
                    <div class="row no-print">
                        <div class="col-xs-12">
                            ...
                            <a href="ViewSingleCompanyProjectDetails.jsp.jsp" class="btn btn-default"><i class="btn-primary"></i>Projects Done</a>
