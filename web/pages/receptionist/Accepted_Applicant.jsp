                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">                                
                                <li><a href="../receptionist/Branch_List.jsp"><i class="fa fa-circle-o"></i>View Branches</a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="../receptionist/Department_List.jsp"><i class="fa fa-circle-o"></i>Departments List</a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="../receptionist/Categories_List.jsp"><i class="fa fa-circle-o"></i>Categories List</a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="../receptionist/Activity_List.jsp"><i class="fa fa-circle-o"></i>Activities List</a></li>
