    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="../forms/Activity_List.jsp"><i class="fa fa-circle-o"></i>Activity List</a></li>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="Join_Activity.jsp?id=<%=ls.get(i).getActivid()%>"><img src="../examples/img/join.jpeg" width="50" height="50"/></a>
                                        </td>
                                       </tr>
                                    <%
                                            no++;
            ...
            <footer class="main-footer">
                ...
                <strong>Copyright &copy; 2016 <a>Institution of Engineers Rwanda</a>.</strong> All rights
                reserved.
            </footer>
            <!-- Control Sidebar -->
