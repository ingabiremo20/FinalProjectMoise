            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <form role="form" action="qualificationprocess.jsp" method="POST">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Name of Institution</label>
                                            <h4 style="color: red">${b.acInstitutionmsg}</h4>
                                            <input type="text" class="form-control" name="acInstitution"  id="exampleInputPassword1" required="" placeholder="Names of Institution" >
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Certificate awarded</label>
                                            <h4 style="color: red">${b.certfAwardmsg}</h4>
                                            <input type="text" class="form-control" name="certfAward" id="exampleInputEmail1" required="" placeholder="Certificate awarded">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Year Of Award</label>
                                            <h4 style="color: red">${b.yearOfAwardmsg}</h4>
                                            <input type="text" class="form-control" name="yearOfAward" id="exampleInputEmail1" required="" placeholder="yyyy" >
                                        </div>
                                        <div class="form-group">
