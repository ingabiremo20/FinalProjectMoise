            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <form role="form" action="Activity_Process.jsp" onsubmit="return validateForm()" method="post">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label>Select Activity Name</label>
                                            <select class="form-control" id="activitname" name="activitname" required="" onblur="validateSelectActivityName(name)" required="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="activitbigDate" name="activitbigDate" onblur="validateactivitbigDate(name)" required="" placeholder="dd/mm/yyyy">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="activitendDate" id="activitendDate" onblur="validateactivitendDate(name)" required="" placeholder="dd/mm/yyyy">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="place" id="place" onblur="validatePlace(name)" required="" placeholder="Place">
