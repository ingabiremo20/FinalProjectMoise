            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <form role="form" action="memberexperiencesprocess.jsp" onsubmit="return validateForm()" method="POST">
                                    <div class="box-body">                                                                          
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">From</label>
                                            <h4 style="color: red">${b.bigdatemsg}</h4>
                                            <input type="date" class="form-control" name="bigdate"  id="bigdate" onblur="validatebigdate(name)" required="" placeholder="dd/MM/yyyy">
                                          
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">TO</label>
                                            <h4 style="color: red">${b.enddatemsg}</h4>
                                            <input type="date" class="form-control" name="enddate" id="enddate" onblur="validateenddate(name)" required="" placeholder="dd/MM/yyyy">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <h4 style="color: red">${b.descriptionmsg}</h4>
                                            <textarea  rows="3" cols="20" class="form-control" name="description" id="exampleInputPassword1" required="" placeholder="Description"></textarea>
                                        </div>
                                    </div>
                                    <!-- /.box-body -->
