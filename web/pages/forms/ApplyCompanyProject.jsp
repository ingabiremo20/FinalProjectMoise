            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                               <form role="form" action="projectprocess.jsp" method="POST">
                                    <div class="box-body">                                     
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Project Name</label>
                                            <textarea rows="2" cols="20" type="text" class="form-control" name="projectname" value=""  id="exampleInputPassword1"required="" ></textarea>
                                        </div>
                                       
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Year</label>
                                            <input type="text" class="form-control" name="projectYear" id="exampleInputEmail1" placeholder="" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Project Client</label>
                                            <input type="text" class="form-control" name="projectClient" id="exampleInputEmail1" placeholder="" required="">
                                        </div>
                                        <div class="form-group">
