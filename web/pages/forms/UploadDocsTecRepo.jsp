            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <form role="form" action="uploadSlipprocessTecRepo.jsp" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <input type="hidden" class="form-control" name="engineer_id" value="<%=u.getEngineer_id()%>" id="exampleInputEmail1">
                                    </div>
                                    <div class="form-group">
                                        <label>Upload Technical Report:</label>
