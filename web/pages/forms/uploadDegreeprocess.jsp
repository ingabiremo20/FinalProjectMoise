...
//=======================================================
    ...
    if (saveFile.contains(".jpg")) {
        ...
        bool = false;
        ValMes = "You must uplaod Your File In jpg Format Only";
...
//========================================================
    ...
    int d = s.nextInt(1000);
     indexName = "Degree_" +u.getEngineer_id()+".jpg";
    if (bool) {
        ...
        try {
            ...
            fileOut1.flush();
            fileOut1.close();
            session.setAttribute("Degree_link", indexName);
            session.setAttribute("yes", 1);
            //out.println(session.getAttribute("yes"));
              Engineer ss = new Engineer();
            ss.setOfficialdoc(indexName);
            if (ss.updateOfficialDoc()){
        ...
        b.setMsg("<h4 style=color:red>You must uplaod Your File In jpg Format Only</h4>");

    }
%>
<jsp:forward page="UploadDocs_1.jsp"/>