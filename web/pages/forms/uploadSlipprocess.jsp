...
//========================================================
    ...
    int d = s.nextInt(1000);
     indexName = "Bank_" +u.getEngineer_id()+".jpg";
    if (bool) {
...
%>
<jsp:forward page="UploadDocs_2.jsp"/>