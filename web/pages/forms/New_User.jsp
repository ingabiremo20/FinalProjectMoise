        ...
        <div id="content">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <h4 style="color: ">${sta.msg}</h4>
                    <h4 style="color: ">${st.msg}</h4>
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <form role="form" action="User_Process.jsp" method="POST">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label>First Name</label>
                                            <h4 style="color: red">${sta.fnamemsg}</h4>
                                            <input type="text" class="form-control" name="fname"  placeholder="First Name"required="">
                                        </div>

                                        <div class="form-group">
                                            <label>Last Name</label>
                                            <h4 style="color: red">${sta.lnamemsg}</h4>
                                            <input type="text" class="form-control" name="lname" required="" placeholder="Last Name">
                                        </div>
                                        <div class="form-group">

                                            <label>Select Branch</label>
                                            <select type="text" name="branchid" value="" class=" form-control" required="">
                                                <option>---Select Branch---</option>
                                                <%                                                    Branches uni = new Branches();
                                                    List<Branches> mydatabr = uni.ViewBranches();
                                                    if (mydatabr.size() != 0) {
                                                        int row = 0;
                                        ...
                                        <div class="form-group">
                                            ...
                                            <h4 style="color: red">${sta.telmsg}</h4>
                                            <input type="text" class="form-control" name="tel"  placeholder="Phone Number" required="">
                                        </div>
                                        <div class="form-group">
                                            <label>Email Address</label>
                                            <h4 style="color: red">${sta.emailmsg}</h4>
                                            <input type="email" class="form-control" name="email"placeholder="Enter email" required="">
                                        </div>
                                        <div class="form-group">
                                            <label>Password</label>
                                            <h4 style="color: red">${sta.passwordmsg}</h4>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <h4 style="color: red">${st.rolemsg}</h4>
