            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                               <form role="form" action="../examples/stockholdprocess.jsp" method="POST">
                                    <div class="box-body">                                     
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Stockholder Name</label>
                                            <input type="text" class="form-control" name="stockholdNames" value=""  id="exampleInputPassword1"required="" >
                                        </div>
                                       
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">National ID Number</label>
                                            <input type="text" class="form-control" name="identification" id="exampleInputEmail1" placeholder="" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Telephone No</label>
                                            <input type="text" class="form-control" name="stockholdTel" id="exampleInputEmail1" placeholder="" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Qualifications</label>
                                            <input type="text" class="form-control" name="stockholdqual" id="exampleInputEmail1" placeholder="" required="">
                                        </div>
                                        <div class="form-group">
                                           
                                            <input type="hidden" class="form-control" name="engineer_id" value="<%=u.getEngineer_id()%>" id="exampleInputEmail1" placeholder="" required="">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">REC/IER Membership No(if Any)</label>
                                            <input type="text" class="form-control" name="recierId"   id="exampleInputEmail1" placeholder="" >
                                        </div>
