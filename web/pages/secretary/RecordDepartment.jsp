                        ...
                        <div class="col-md-6">
                            ...
                            <div class="box box-primary">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Recording Department</h3>
                                </div>
                                <!-- /.box-header -->
                                <!-- form start -->
                                <h4 style="color: red">${p.msg}</h4>
                                <form role="form" action="DepartmentProcessing.jsp" method="POST">
                                    <div class="box-body">                                                                          
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Department Name</label>
                                            <input type="text" class="form-control" name="departmentname" id="exampleInputEmail1" required="" placeholder="Department Name">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Description</label>
                                            <input type="text" class="form-control" name="departmentdesc" id="exampleInputEmail1" required="" placeholder="Description">
                                        </div>
                                ...
                                <jsp:include page="departmentView.jsp"/>
                            </div>
