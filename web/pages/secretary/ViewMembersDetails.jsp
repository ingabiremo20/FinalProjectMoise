                            ...
                            <table class="table table-striped" border="">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td ><a href="../../pages/CVs/<%=muList.get(row).getCv()%>" style="color: yellowgreen">Review</a>
                                        <td ><a href="../../pages/CVs/<%=muList.get(row).getOfficialdoc()%>" style="color: yellowgreen">Review</a>

                                        <td ><a href="../../pages/CVs/<%=muList.get(row).getBankslip()%>" style="color: yellowgreen">Review</a>
                                        <td ><a href="../../pages/CVs/<%=muList.get(row).getBankslip()%>" style="color: yellowgreen">Review</a>
                                        <td ><a href="../../pages/CVs/<%=muList.get(row).getBankslip()%>" style="color: yellowgreen">Review</a>
                                        <td ><a href="../../pages/CVs/<%=muList.get(row).getBankslip()%>" style="color: yellowgreen">Review</a>
