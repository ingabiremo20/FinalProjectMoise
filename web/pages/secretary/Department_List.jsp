                ...
                <section class="invoice">
                    ...
                    <tbody>
                        ...
                        <tr style="color: blue;background-color: whitesmoke;">
                            ...
                            <td><a href="DeleteDepartment.jsp?id=<%=compList.get(i).getDepartmentid()%> ">Delete</a></td>
                            <td><a href="UpdateDepartment.jsp?id=<%=compList.get(i).getDepartmentid()%> ">Update</a></td>
                            <td style="background-color: #DDDDDD"><a href="../secretary/ViewDepartmentMemberlist.jsp?mid=<%=compList.get(i).getDepartmentid()%>">Department Members </a></td>
                        </tr>                    <%
                        } else {
                        %>
