                        ...
                        <div class="col-md-6" style="float: left">
                            ...
                            <tbody>
                                ...
                                <%
                                    ...
                                    List<Engineer> muList = dd.ViewMemberDetails(session.getAttribute("proid").toString());
                                ...
                                <tr>
                            <h3 class="box-title">Make Decision on  <p style="color: blue"><%=muList.get(row).getNames()%> </p>
                             
                            Who has the following Email  <p style="color: blueviolet"><%=muList.get(row).getEmails()%> </p>
                            Whose Status is  <p style="color: red"><%=muList.get(row).getStatus()%> </p>
                            </h3> 
                            
                                </tr>
                                
                                 <tr>
                                    <td><a href="Update_Accept.jsp?engineer_id=<%=muList.get(row).getEngineer_id()%>&op=Accepted"><button class="btn btn-primary">Unlock</button></a> </td>
                                    <td><a href="Update_Locked.jsp?engineer_id=<%=muList.get(row).getEngineer_id()%>&op=Locked"><button class="btn btn-primary">Lock</button></a> </td>
                                    <td><a href="Update_Accept.jsp?engineer_id=<%=muList.get(row).getEngineer_id()%>&op=Accepted"><button class="btn btn-primary">ACCEPT</button></a> </td>
                                    <td><a href="Update_Reject.jsp?engineer_id=<%=muList.get(row).getEngineer_id()%>&op=Rejected"><button class="btn btn-primary" style="background-color: #990000">REJECT</button></a> </td>
                                   </tr>
