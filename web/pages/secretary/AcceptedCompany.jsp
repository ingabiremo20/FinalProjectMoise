                ...
                <div style="margin-left: 50px;margin-right: 10px">     
                    ...
                    <div  style="overflow: auto">
                        <table border="1" id="myDemo">
                            ...
                            <%                            List<Engineer> ls = Engineer.getListOfCompanyAccepted();
                                {
                            %>
                            ...
                            <tbody>
                              ...
                              <td><%=no%></td>
                                    ...
                                    <td style="background-color: #DDDDDD"><a href="../secretary/ViewSingleCompanyProjectDetails.jsp?mid=<%=ls.get(i).getEngineer_id()%>">More Details</a></td>
                                 </tr>
                                <%
                                        no++;
                                    }
