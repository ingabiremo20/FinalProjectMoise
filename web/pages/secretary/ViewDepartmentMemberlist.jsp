                ...
                <section class="invoice">
                               ...
                               <thead style="background-color:skyblue">
                                    ...
                                    <tbody>
                                        ...
                                        <%
                                            ...
                                            List<Memberships> muList = dd.ViewDepartmentMemberlist(session.getAttribute("proid").toString());
                                        ...
                                        <tr>
                                            ...
                                            <td><%= muList.get(row).getMemberemail()%></td>
                                            <td><%= muList.get(row).getMemberphone()%></td>
                                            <td><%= muList.get(row).getMemberstatus()%></td>
                    ...
                    <div class="row no-print">
                        <div class="col-xs-12">
                            ...
                            <a href="Enginer_reportByDept.jsp" class="btn btn-default"><i class="fa fa-print"></i>PRINT</a>
