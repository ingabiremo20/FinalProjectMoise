                                ...
                                <div class="box-header with-border">
                                    ...
                                    <table border="0" id="myDemo">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                        <h3 class="box-title">Notify  <p style="color: red"><%=muList.get(row).getNames()%> </p></h3>                                    
                                        </tr>
                                       <h4 style="color: red">${st.msg}</h4>
                                        <form role="form" action="../../mailJSP.jsp" method="POST">
                                            <div class="box-body">

                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">His/Her Email</label>
                                                    <input type="text" class="form-control" name="mail" value="<%=muList.get(row).getEmails()%>" id="exampleInputEmail1" readonly="" placeholder="Registration N0">
                                                </div>
                                                <div class="form-group">
                                                    
                                                    <input type="text" class="form-control" name="sub" id="exampleInputEmail1" required="" value="IER Registration notification" readonly="">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Message</label>
                                                    <textarea rows="4" cols="55" name="mess"></textarea><br/>
                                                </div>
