                            ...
                            <table class="table table-striped" border="">
                                ...
                                <tbody>
                                    ...
                                    <%
                                        ...
                                        List<Engineer> muList = dd.ViewSingleCompanyDetails(session.getAttribute("proid").toString());
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="Update_AcceptCompany.jsp?engineer_id=<%=muList.get(row).getEngineer_id()%>&op=Accepted">Accept</a> <td><a href="Update_Reject.jsp?memberid=<%=muList.get(row).getEngineer_id()%>&op=Rejected">reject</a>
