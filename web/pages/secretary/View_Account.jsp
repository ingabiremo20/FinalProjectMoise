...
<html>
    <head>
        ...
        <title>View your Account /IER</title>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a href="../forms/Apply.jsp">
                                <i class="fa fa-th"></i> <span>Apply for Member</span>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <h2 class="page-header">
                                <i class="fa fa-globe"></i>Applicants 
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <%                                        Connection con = enginees.DBClassConnector.getConnection();
                                        ...
                                        ResultSet rs = null;
                                        rs = sta.executeQuery("select * from engineer");
                                    %>
                                    ...
                                    <tr>
                                        ...
                                        <td ><a href="../../pages/CVs/<%=rs.getString(20)%>" style="color: yellowgreen"target="_blank">Review</a>
                                        <td ><a href="../../pages/CVs/<%=rs.getString(20)%>" style="color: yellowgreen"target="_blank">Review</a>
                                        <td><a href="Update_Accept.jsp?engineer_id=<%=rs.getString(1)%>&op=Accepted">Accept</a> <td><a href="Update_Reject.jsp?engineer_id=<%=rs.getString(1)%>&op=Rejected">reject</a>
