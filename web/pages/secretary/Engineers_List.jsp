            ...
            <ul id="menu" class="collapse">
                ...
                <li class="panel ">
                    ...
                    <ul class="collapse" id="component-nav">
                        ...
                        <li><a href="../examples/LoginMember.jsp" target="_blank"><i class="icon-angle-right"></i>Record New Engineer</a></li>
                        <li><a href="../secretary/Engineers_List.jsp"><i class="icon-angle-right"></i>Applicants</a></li>
                        <li><a href="../secretary/LockedEngineers.jsp"><i class="icon-angle-right"></i>Locked Members </a></li>                           
                        ...
                        <li><a href="../secretary/PendingMembers.jsp"><i class="icon-angle-right"></i>Uncompleted Applications</a></li>
                ...
                <li class="panel ">
                    ...
                    <ul class="collapse" id="form-nav">
                        <li><a href="../secretary/Company_List.jsp"><i class="icon-angle-right"></i>Companies Applications</a></li>
                        ...
                        <li><a href="../secretary/PendingCompany.jsp"><i class="icon-angle-right"></i>Uncompleted Applications</a></li>
                        <li><a href="../secretary/AllAcceptedMembers.jsp"><i class="fa fa-circle-o"></i>All Accepted Members </a></li>
