...
<body class="hold-transition skin-blue sidebar-mini" >
    ...
    <div id="wrap" >
            ...
            <ul id="menu" class="collapse">
                ...
                <li class="panel ">
                    ...
                    <ul class="collapse" id="component-nav">
                        ...
                        <li><a href="../Vicepresident/LockedEngineers.jsp"><i class="icon-angle-right"></i>Locked Engineers </a></li>                           
                        <li><a href="../Vicepresident/RejectedEngineers.jsp"><i class="icon-angle-right"></i>Rejected Applications</a></li>                           
                        <li><a href="../Vicepresident/AcceptedEngineers.jsp"><i class="icon-angle-right"></i>Accepted Engineers</a></li>                           
                        <li><a href="../Vicepresident/PendingMembers.jsp"><i class="icon-angle-right"></i>Engineers Applications</a></li>
                        <li><a href="../Vicepresident/AllAcceptedMembers.jsp"><i class="fa fa-circle-o"></i>All Accepted Members </a></li>
                ...
                <li class="panel ">
                    ...
                    <ul class="collapse" id="form-nav">
                        <li><a href="../Vicepresident/ChangePassword.jsp"><i class="fa fa-circle-o"></i>Change Password</a></li>
        ...
        <div id="content">
            ...
            <div class="span_11">
                <center > <img src="../../pages/images/LogoIER.jpg"><span class="badge"></span>
