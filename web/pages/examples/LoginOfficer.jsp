...
<script src="../../js/button.js" async="" charset="utf-8" type="text/javascript"></script></head>
    <body class="featured homepage  ltr preset3 menu-home responsive bg hfeed clearfix">
                ...
                <div class="container" style="background: whitesmoke">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <center> <h1 style="font-size: 40px">Staff Login</h1></center>
                    ...
                    <div class="row register-form">
                        <div class="col-sm-4 col-sm-offset-1" style="background: white">
                            <center><form role="form" action="Staff_Login_Process.jsp" method="post" class="l-form" >
                                    <p> ${s.msg}</p>
                                    <div class="form-group">
                                        <label ><span><b>Your Email</b></span></label>
                                        <input type="text" name="username" placeholder="Email" class="l-form-username form-control" id="l-form-username">
                                    </div>
                                    <div class="form-group">
        ...
        <footer id="sp-footer-wrapper" class=" "><div class="container"><div class="row-fluid" id="footer">
                    <div id="sp-footer1" class="span8"><center><span class="copyright">Copyright &copy; 2017 <a href="#">Institution of Engineers Rwanda</a>.</strong> All rights
