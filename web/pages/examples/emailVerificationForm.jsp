                ...
                <div class="container" style="background: whitesmoke">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <center> <h1 style="font-size: 40px">Password Reset</h1></center>
                    ...
                    <div class="row register-form">
                        <div class="col-sm-4 col-sm-offset-1" style="background: whitesmoke">
                            <center><form role="form" action="../forms/ProcessVerifyEmail.jsp" method="post" class="l-form">
                            <h4 style="color: red">${st.msg}</h4>
                            <div class="form-group">
                                <label><b>Email Address</b></label>
                                <input type="text" name="emails" placeholder="Email Address" class="l-form-username form-control" id="l-form-username">
                            </div>
                            
                            <button type="submit" class="btn-primary">Verify</button>
                            <label>&nbsp;&nbsp;&nbsp;</label>
                            <label> <a href="../../pages/examples/LoginMember.jsp">Back To Login</a></label>
