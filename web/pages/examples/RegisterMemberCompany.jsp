                ...
                <div class="container" style="background: whitesmoke">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <center> <h1 style="font-size: 35px">Company Registration Form</h1></center>
                        ...
                        <div class="col-sm-4 col-sm-offset-1" style="background: white">
                            <center><form  action="Login_Process.jsp" onsubmit="return validateForm()" method="post" class="r-form">
                                    ...
                                    <div class="form-group">
                                        <label ><span><b>Company Name</b></span></label> 
                                        <h4 style="color: red">${st.namesmsg}</h4>
                                        <input type="text" name="names" id="names" placeholder="Company Name" onblur="validateName(name)" required=""  />
                                       </div>
                                    <div>
                                        <label for="email">Company Email</label>
                                        <h4 style="color: red">${st.emailsmsg}</h4>
                                        <input type="text" name="emails" id="emails"placeholder="Company Email" onblur="validateEmail(name)" required=""  />
                                       
                                    </div>
                                    <div class="form-group">
                                        <label ><span><b>Password</b></span></label>
                                        <h4 style="color: red">${st.passwordmsg}</h4>
                                        <label style="color: red"><span><b>${st.passwordmsg}</b></span></label>
                                        <input type="password" id="password" name="password" placeholder="Password" onblur="validatePassword(name)" class="r-form-last-name form-control" required="" id="r-form-last-name">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="tagid1" value="REC">
                                    </div>
                                    <div class="form-group">

                                        <input type="hidden" name="tagid2" value="ECF">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="memberphone" name="memberphone" onblur="validatePhone(name)" class="r-form-first-name form-control" id="r-form-first-name"  required="" placeholder="Phone Number">
                                         <span  class="validateError" id="memberphoneError" style="display: none; color: red">Phone Number must be 10 Digits</span>
