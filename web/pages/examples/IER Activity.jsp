        ...
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <h1>
                        List of IER Activity
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="index.jsp"><i class="fa fa-dashboard"></i>Home</a></li>
                        <li><a href="User_List.jsp">System User</a></li>
                    </ol>
                </section>
                <!-- Main content -->
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <h2 class="page-header">
                                <i class="fa fa-globe"></i>IER Activity
                        ...
                        <div class="col-xs-12 table-responsive">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    %>
                                    <tr>
                                        <td><a href="Delete_Engineer.jsp?id=<%=ls.get(i).getActivity_id()%>"><img src="img/upda.PNG" width="25" height="25"/></a>
                                        <td><%=no%></td>
                                        <td><%=ls.get(i).getActivity_name()%></td>
                                        <td><%=ls.get(i).getCategory()%></td>
                                        <td><%=ls.get(i).getDetail()%></td>
                                        <td><a href="Delete_Engineer.jsp?id=<%=ls.get(i).getActivity_id()%>"><img src="img/fer.PNG" width="32" height="32"/></a>
                                        </td>
                                    </tr>
                                    <%
                                            no++;
