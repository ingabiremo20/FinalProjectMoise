                     ...
                     <li class="treeview">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="ViewMembersDetails.jsp"><i class="fa fa-circle-o"></i>View Members</a></li>
                            </ul>
                        </li>
                ...
                <section class="invoice">
                            ...
                            <table class="table table-striped" border="">
                               <thead style="background-color:skyblue">
                                    ...
                                    <tbody>
                                        ...
                                        <%
                                            Memberships dd = new Memberships();
                                            List<Memberships> muList = dd.ViewSingleMemberDetails(session.getAttribute("proid").toString());
                                        ...
                                        <tr>
                                            <td><%=muList.get(row).getMemberid()%></td>
                                            <td><%=muList.get(row).getMembernames()%></td>
                                            <td><%= muList.get(row).getMembertype()%></td>
                    ...
                    <div class="row no-print">
                        <div class="col-xs-12">
                            ...
                            <a href="ViewMembersDetails.jsp" class="btn btn-default"><i class="btn primary"></i>Documents</a>
