                    ...
                    <div  style="overflow: auto">
                        <table border="1" id="myDemo">
                            ...
                            <tbody>
                                ...
                                <%while (rs.next()) {%>
                                <tr>
                                    <td><%=rs.getString(24)+ "" + rs.getString(1) + "/" + rs.getString(25) + "/" + rs.getString(26) + "/" + rs.getString(1)%></td>
                                    ...
                                    <td ><a href="../../pages/CVs/<%=rs.getString(18)%>" style="color: yellowgreen" target="_blank">Review</a>|
                                        <a href="../forms/uploadCVprocessCompany.jsp?id=<%=rs.getString(1)%>&op=CV_<%=rs.getString(1) + ".pdf"%>">Upload_Here</a></td>
                                    <td ><a href="../../pages/CVs/<%=rs.getString(19)%>" style="color: yellowgreen" target="_blank">Review</a>|
                                        <a href="../forms/uploadDegreeprocess_1comp.jsp?id=<%=rs.getString(1)%>&op=Degree_<%=rs.getString(1) + ".jpg"%>">Upload_Here</a></td>
                                    <td ><a href="../../pages/CVs/<%=rs.getString(20)%>" style="color: yellowgreen" target="_blank">Review</a>|
                                        <a href="../forms/uploadSlipprocess_1.jsp?id=<%=rs.getString(1)%>&op=Bank_<%=rs.getString(1) + ".jpg"%>">Upload_Here</a></td>
                                    <td ><a href="../../pages/CVs/<%=rs.getString(23)%>" style="color: yellowgreen" target="_blank">Review</a>|
                                        <a href="../forms/uploadProPhotoprocess.jsp?id=<%=rs.getString(1)%>&op=Pphoto_<%=rs.getString(1) + ".jpg"%>">Upload_Here</a></td>
                                </tr>
                                <%
