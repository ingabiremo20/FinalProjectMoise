            ...
            <nav class="main-header" style="padding-top: auto;">
                ...
                <ul class="nav navbar-top-links navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user" style="background: #4682B4">
        ...
        <div id="content">
            <div style="width: 100%;margin-top: -8px;height: auto;border-bottom:   0px black solid;">
                <center>
                    ...
                    <h2>Welcome to Online management of civil engineers activities </b>for Institution of Engineers Rwanda</h2>
                </center>
            </div>
            <div class="span_11">
