                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="AllAcceptedMembers.jsp"><i class="fa fa-circle-o"></i>View Members</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="AllAcceptedMembers.jsp"><i class="fa fa-circle-o"></i>Accepted Engineer</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
