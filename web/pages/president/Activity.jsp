                                ...
                                <form role="form" action="Activity_Process.jsp" onsubmit="return validateForm()" method="post">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="activitname" name="activitname" onblur="validateSelectActivityName(name)" required="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="activitbigDate" name="activitbigDate" onblur="validateactivitbigDate(name)"  placeholder="Starting Date">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="activitendDate" id="activitendDate" onblur="validateactivitendDate(name)" placeholder="Ending Date">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="place" id="activitendDate"  placeholder="Place">
