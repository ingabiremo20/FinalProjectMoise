            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-6">
                                <form role="form" action="Activity_Process_1.jsp" onsubmit="return validateForm()" method="post">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label>Select Activity Name</label>
                                            <select class="form-control" id="activitname" name="activitname" value="${st.activitname }" required="" onblur="validateSelectActivityName(name)" required="">
                                                <option>--Select Activity Name--</option>
                                                <option>Conference</option>
                                                <option>Training</option>
                                                <option>Other</option>
                                            </select>
                                            <span  class="validateError" id="activitnameError" style="display: none; color: red">You must select the Activity Name</span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" rows="3" name="activitdetails" required="" value="${st.activitdetails}" placeholder="Enter Detail..."></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">FROM</label>
                                            <input type="text" class="form-control" id="activitbigDate" name="activitbigDate" value="${st.activitbigDate}" onblur="validateactivitbigDate(name)" required="" placeholder="dd/mm/yyyy">
                                            <span  class="validateError" id="activitbigDateError" style="display: none; color: red">Invalid Date Format! use dd/mm/yyyy</span>

                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">TO</label>
                                            <input type="text" class="form-control" name="activitendDate" id="activitendDate" value="${st.activitendDate}" onblur="validateactivitendDate(name)" required="" placeholder="dd/mm/yyyy">
                                            <span  class="validateError" id="activitendDateError" style="display: none; color: red">Invalid Date Format! use dd/mm/yyyy</span>

                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Place </label>
                                            <input type="text" class="form-control" name="place" id="place" onblur="validatePlace(name)" value="${st.place}" required="" placeholder="Place">
                                            <span  class="validateError" id="placeError" style="display: none; color: red">First Letter must be Capital</span>

                                        </div>
                                        <div class="form-group">
                                           
                                            <input type="hidden" class="form-control" name="activitstatus" id="place" onblur="validatePlace(name)" value="${st.activitstatus}" required="" placeholder="Place">
                                            <span  class="validateError" id="placeError" style="display: none; color: red">First Letter must be Capital</span>

                                        </div>
                                        <div class="form-group">
                                            
                                            <input type="hidden" class="form-control" name="activid" id="place" onblur="validatePlace(name)" value="${st.activid}" required="" placeholder="Place">
                                            <span  class="validateError" id="placeError" style="display: none; color: red">First Letter must be Capital</span>
