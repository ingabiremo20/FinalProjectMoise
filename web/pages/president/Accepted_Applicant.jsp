                    ...
                    <!-- sidebar menu: : style can be found in sidebar.less -->
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="../president/Engineers_List.jsp"><i class="fa fa-circle-o"></i>View Engineers</a></li>                           
                                <li><a href="../president/Engineers_List.jsp"><i class="fa fa-circle-o"></i>Uncompleted Applications</a></li>                           
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="../president/Activity_List.jsp"><i class="fa fa-circle-o"></i>Activities List</a></li>
