...
<!DOCTYPE html>
<%
    User u = (User) session.getAttribute("VicePresident");
    if (u == null) {
%>
          ...
          <div id="left">
            <ul id="menu" class="collapse">
                ...
                <li class="panel active">
                    <a href="../examples/VicePresidentHome.jsp" >
...
<li><a href="LockedEngineers.jsp"><i class="icon-angle-right"></i>Locked Engineers </a></li>                           
                        <li><a href="RejectedEngineers.jsp"><i class="icon-angle-right"></i>Rejected Applications</a></li>                           
                        <li><a href="AcceptedEngineers.jsp"><i class="icon-angle-right"></i>Accepted Engineers</a></li>                           
                        <li><a href="PendingMembers.jsp"><i class="icon-angle-right"></i>Engineers Applications</a></li>
                        <li><a href="AllAcceptedMembers.jsp"><i class="fa fa-circle-o"></i>All Accepted Members </a></li>
                ...
                <li><a href="../examples/VicePresidentHome.jsp"><i class="icon-film"></i> Back </a></li>
            </ul>
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 300px;">
                <div class="row">
                    <div class="col-lg-12">
                        <center>  <h2>Individual Applicants List Details</h2></center>
                ...
                <div style="margin-left: 50px;margin-right: 10px">     
                    ...
                    <div  style="overflow: auto">
                        <table border="1" id="myDemo">
                            ...
                            <%                            List<Engineer> ls = Engineer.getListOfApplicantsPending();
                                {
                            %>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td ><a href="../../pages/CVs/<%=ls.get(i).getTecreport()%>" style="color: yellowgreen"target="_blank">Review</a>
                                    <td ><a href="../../pages/CVs/<%=ls.get(i).getNid()%>" style="color: yellowgreen"target="_blank">Review</a>
                                    <td ><a href="../../pages/CVs/<%=ls.get(i).getProphoto()%>" style="color: yellowgreen"target="_blank">Review</a>
                                     </tr>
                                <%
                                        no++;
                                    }
