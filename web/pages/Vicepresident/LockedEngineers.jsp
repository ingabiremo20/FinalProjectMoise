...
<head>
    ...
    <meta charset="UTF-8" />
    <title>Online Management of Civil Engineers Activities for IER</title>
    ...
    <div id="wrap" >
        ...
        <div id="content">
            ...
            <div class="inner" style="min-height: 300px;">
                <div class="row">
                    <div class="col-lg-12">
                        <center>  <h2>Suspended  Members</h2></center>
                ...
                <div style="margin-left: 50px;margin-right: 10px">     
                    ...
                    <div  style="overflow: auto">
                        <table border="1" id="myDemo">
                            ...
                            <%                            List<Engineer> ls = Engineer.getListOfIndividualLocked();
                                {
                            %>
